...
output_dir = input("Enter outuput path: \n")
...
# Average hourly demand values in m3/h/hectar
demand_values = {key: v*0.00039 for key,v in demand_values.items()}

# Roughness
roughness_values = [100, 110, 130]

# Reservoir's elevetation over the highest point
...
for i in range(number_of_WDN):
        ...
        print ('Layout n: {} ' .format(i) + 'was generated succefully')
        ...
        # Divid the network to sectors and add valves between sectors
        wn = rd.add_valves(wn)
...
print("Succesfully created {}" .format(number_of_WDN) + "of WDN's located in " + output_dir)
